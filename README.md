...
4. **文化与歌词特征探究**：特定流派中高频词汇（如歌词中的情感词）与该流派声学表现之间是否存在某种隐含的“指纹”关系？
...
- **流派与词频画像分析**：提供流派发展变迁折线图与文本特征词云，并支持词频加权的情感指纹分析。
...
- **功能职责**：提供微观层面的单曲属性和上下文画像。包含**歌曲列表**、**流派画像悬浮窗**、**歌词特征透视窗**以及**单曲声学指纹比对窗**。
- **功能细节**：
...
- **歌词词频多维透视**：在展示歌词词频的情感指纹时，系统避开了常规的堆叠柱状图：
...
### 5.1 分析目的
探索“华语流行（华语流行）”流派在声学特征、情感分布以及文本主题上的深层指纹。
...
4. **单曲微观校验**：
   - 在右侧歌曲列表中点击经典曲目《红豆》。中栏的 KMeans 星云图反向高亮该单曲，红色光圈在“伤感静谧”区域中心频频闪烁。同时，单曲声学指纹比对雷达图弹出，显示这首歌的“能量”为 `0.23`（远低于全球流行大盘均值），而“声学度（acousticness）”高达 `0.78`（远高于流派均值），量化证实了该曲目的抒情特异性。
5. **歌词文化与情感映射**：
   - 关闭星云图，查看流派画像小窗。词云中展示了“华语流行”的 20 个高频词汇，“眼泪”、“世界”、“温柔”、“爱情”赫然在列。
   - 点击词云中的词汇“眼泪”。歌词词频多维特征透视仪随即在左下角弹出。南丁格尔玫瑰图显示，“眼泪”这一词汇高频出现于“华语流行”、“粤语流行”及“韩国流行”这几个流派中。极坐标单轴放射柱状图则展示了其情感指纹：加权计算后的情感效价较低（`0.38`），能量较低（`0.41`），完美契合了“眼泪”一词在东亚流行音乐文化中所折射出的忧郁、抒情的声学环境。

### 5.3 案例结论
通过本系统的联动分析，我们能够直观且科学地归纳出：华语流行音乐在声学上表现为中低能量、重人声、轻器乐，情感空间归属于“伤感静谧”与“轻松愉快”聚类，词汇文化则高度聚焦在“眼泪”、“爱情”等感性意象上。这充分证明了系统在分析多维异构数据方面的有效性。
